...
class ImportBuildMap(bpy.types.Operator, ImportHelper):
    ...
    def execute(self, context):
        ...
        try:
            ...
            tex_importer = texture_importer.TextureImporter(bmap, folders=[self.selectedUserArtTextureFolder, self.selectedTextureFolder], parse_png_jpg_first=self.loadPngJpgFirst)
